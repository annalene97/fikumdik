...
var kaffeModal = document.getElementById("mad_kaffe_modal");

// Vi finder kaffe knappen (billedet af kaffeknappen)
var kaffeKnap = document.getElementById("mad_kaffeimg_knap");

// Vi finder <span> element som lukker Kaffe modal
var lukKaffeModal = document.getElementById("lukknap_kaffe_modal");
...
var bagvaerkModal = document.getElementById("mad_bagvaerk_modal");

// Vi finder bagværk knappen (billedet af bagværkknappen)
var bagvaerkKnap = document.getElementById("mad_bagimg_knap");

// Vi finder <span> element som lukker bagværk modal
var lukBagvaerkModal = document.getElementById("lukknap_bagvaerk_modal");
